...
const ShopItem = ({supplier,name,colour,imageUrls,occasion,size,category,cashondelivery,ratings,originalprice,discountper,description,quantity,onClick,onRemove,moveWishlist,noofratings,agerated}:ShopItemProps) => {
    ...
    <div className="flex flex-row gap-x-2 ">
        ...
        <div className="flex flex-col gap-y-2">
            ...
            <div className="font-semibold  flex flex-row gap-x-1 text-xl text-black">
                Quantity: {quantity}
        ...
        <div className="flex flex-col  p-2 m-2 gap-y-2">
            <div className="font-bold text-2xl flex flex-col gap-y-1 text-black">
                ...
                <div className="border-2  p-5 m-5 bg-orange-500 rounded-lg border-black group flex  items-center justify-center flex-row gap-x-1" onClick={onClick}>
                    <ShoppingCart className="text-black group-hover:text-blue-500" height={20} width={20}/>
